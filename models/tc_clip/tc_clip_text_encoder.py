...
class VPTextEncoder(nn.Module):
    def __init__(self, clip_model):
        ...
        self.n_ctx = 4
        self.im_stop_grad = True
        cfg_prompt_generation_layer_level = 12
        if isinstance(cfg_prompt_generation_layer_level, str):
            self.prompt_generation_layer_level = list(map(int, cfg_prompt_generation_layer_level.split('+')))
        elif isinstance(cfg_prompt_generation_layer_level, int):
            self.prompt_generation_layer_level = [cfg_prompt_generation_layer_level]
        else:
            self.prompt_generation_layer_level = cfg_prompt_generation_layer_level
        ...
        self.prompt_generation_layer_init = "clip"
