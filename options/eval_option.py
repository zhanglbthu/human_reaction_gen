...
class EvalT2MOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--text_prompt', default='', type=str, help="A text prompt to be generated.")
        ...
        self.parser.add_argument("--motion_length", default=0, type=int,
                                 help="Motion length for generation, only applicable with single text prompt or video.")
        
        self.parser.add_argument('--video_path', default='', type=str, help="A path of a video to be used to generate reaction.")
        self.parser.add_argument('--video_path_file', default='./assets/video_paths.txt', type=str, help="A file containing the video paths")
        self.parser.add_argument('--is_train_dataset', default=False, action="store_true", help="Generate on training dataset or test dataset")
