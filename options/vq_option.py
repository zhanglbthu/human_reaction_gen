...
def arg_parse(is_train=False):
    ...
    ## dataloader
    parser.add_argument('--dataset_name', type=str, default='humanml3d', help='')
    ...
    parser.add_argument('--vq_act', type=str, default='relu', choices=['relu', 'silu', 'gelu'],
                        help='')
    parser.add_argument('--vq_norm', type=str, default=None, help='')

    parser.add_argument('--num_quantizers', type=int, default=3, help='num_quantizers')  # number of RQ = num_quantizers - 1
    ...
    parser.add_argument('--is_continue', action="store_true", help='continue training a model from an interrupted training')
    parser.add_argument('--finetune', action="store_true", help='')
    parser.add_argument('--finetune_model_dir', type=str, default='./checkpoints/t2m/rvq_nq6_dc512_nc512_noshare_qdp0.2/model', help='')
